...
from lib.segmentation.filter import find_mode_bin
import scienceplots
...
def lever_rule_data(logs, output_path, vf_statistic, use_root_N = True, use_filtered = False, bins_for_mode = 30):
    ...
    for log in logs:
        ...
        mode_vf = find_mode_bin(vfs, bins_for_mode)
        ...
        for i, vf_unc in enumerate(vf_unc_li):
            binning_unc = (1/bins_for_mode)/2
            if vf_unc < binning_unc:
                vf_unc_li[i] = binning_unc
    ...
    match vf_statistic:
        ...
        case "mode":
            return lddf, conc_li, mode_vf_li, conc_unc_li, vf_unc_li
