...
def extract_cap_number(string):
    # Use regular expression to find the pattern "Cap" followed by digits
    ...
    if match:
        ...
        # If no match is found, return None or raise an exception as per your requirement
        return None  # or raise ValueError("No 'Cap' followed by a number found")
