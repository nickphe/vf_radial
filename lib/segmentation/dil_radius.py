...
class Circles:
    # circles handles the drawing of circles on a droplet image
    def __init__(self, locs):
        points_x, points_y = locs.T 
                    ...
                    for point_1 in self.point_list:
                        for point_2 in self.point_list:
                            ...
                            if point_1 is not point_2:       
                                ...
                                if point_1.radius + point_2.radius >= distance + EPS:
...
def dil_radii(locs):
    ...
    radius_li = []
    for drop in circles.point_list:
        radius = drop.radius
